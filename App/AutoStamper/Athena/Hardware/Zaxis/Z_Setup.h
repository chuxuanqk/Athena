...
//使能驱动器ENA
#define Z_ENA_CLK       RCC_APB2Periph_GPIOA
#define Z_ENA_PIN       GPIO_Pin_6
#define Z_ENA_PORT      GPIOA
...
#define Z_TIM_SetCompare3    TIM_SetCompare3
...
#define T1_FREQ     (SystemCoreClock/(Z_TIM_PRESCALER + 1))     // 定时器频率
